  var environment =  (function (window,document, $){
  ...
  self.init = function() {
      ...
      camControls[3] = folderCamera.add(cameraVars, 'xRange',0,20).step(1);
      camControls[4] = folderCamera.add(cameraVars, 'yRange',0,20).step(1);
